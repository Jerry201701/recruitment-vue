  ...
  <div class="headbar" :style="{'background':themeColor}" 
    ...
    <span class="navbar">
      <el-menu :default-active="activeIndex" class="el-menu-demo" 
        ...
        <el-menu-item index="5" @click="openWindow('http://waimai.51diane.com/')">产品展示</el-menu-item>
        <el-menu-item index="5" @click="openWindow('http://waimai.51diane.com/')">官网首页</el-menu-item>
      </el-menu>
    </span>
    <!-- 工具栏 -->
    <span class="toolbar">
